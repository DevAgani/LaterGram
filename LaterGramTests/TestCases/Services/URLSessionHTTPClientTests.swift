...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnRequestError() {
        ...
        let receievedError = resultErrorFor(data: nil, response: nil, error: requestError) as NSError?
        
        XCTAssertEqual(receievedError?.domain, requestError.domain)
    }
    ...
    /// Intercept URLSessionHTTPClient requests and stub the responses
